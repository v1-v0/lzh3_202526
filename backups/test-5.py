...
class BacteriaReviewTool:
    ...
    def generate_review_sheet(self, pair_index):
        """Generate a review sheet for a single image pair using original source images in portrait orientation"""
        ...
        # Create figure with portrait orientation and wider width
        ...
        # Create grid layout with space for header and footer
        ...
        # Add main title in header space
        ...
        # Row 3: Statistics (spanning both columns)
        ...
        # Row 4: Parameters (spanning both columns)
        ...
        info_text = (
            ...
            f"• Original fluorescence from _ch01.tif (unprocessed)\n"
            f"• Reserved space for header and footer\n"
            f"• Maximized image sizes\n"
            f"• Fixed text overlap\n\n"
            "COLOR LEGEND:\n"
        ...
        # Row 5: Empty (minimized for image space)
